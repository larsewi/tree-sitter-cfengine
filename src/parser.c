...
enum {
  ...
  sym_bundle = 10,
  sym_bundle_body = 11,
  sym_bundle_statement = 12,
  sym_body = 13,
  aux_sym_source_file_repeat1 = 14,
  aux_sym_bundle_body_repeat1 = 15,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [27] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_bundle_body_repeat1, 2),
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_bundle_body_repeat1, 2), SHIFT_REPEAT(13),
  [32] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 1),
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_body, 3, .production_id = 1),
  [36] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bundle, 4, .production_id = 2),
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bundle_body, 2),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bundle_body, 3),
  [42] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_bundle_statement, 1),
